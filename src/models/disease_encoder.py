"""
WORK IS PENDING, THIS MUST BE MODIFIED IN CONTEXT OF DISEASES
"""
...
class DiseaseEncoderLayer(nn.Module):
    def __init__(
        self,
        embedding_dim: int,
        heads: int,
...
class DiseaseEncoder(nn.Module):
    """
    Biology-structured Transformer encoder for diseases.
    Output:
        Learned representation for every disease.
    """
    ...
    def forward(
        ...
        num_diseases = self.embedding.num_embeddings
